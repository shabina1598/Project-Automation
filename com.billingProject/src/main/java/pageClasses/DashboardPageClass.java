...
public class DashboardPageClass {
	...
	@FindBy(xpath = "//a[@href='https://qalegend.com/billing/public/users']//span[contains(text(),'Users')]")
	WebElement userSubMenu;
	@FindBy(xpath = "//button[@id='start_tour']")
	WebElement helpBtn;
	@FindBy(xpath = "//span[text()='Contacts']")
	WebElement contactsMenu;
	@FindBy(xpath = "//a[@href='https://qalegend.com/billing/public/contacts/import']")
	WebElement importContactssubMenu;
	@FindBy(xpath = "//a[@class='logo']")
	WebElement logo;
	@FindBy(xpath = "//a[@class='dropdown-toggle' and @data-toggle='dropdown']")
	WebElement usernameOnTitlebar;
	@FindBy(xpath = "//a[@href='https://qalegend.com/billing/public/user/profile']")
	WebElement profile;
	...
	WebElement customerGroupsSubMenu;
	@FindBy(css = "#view_todays_profit")
	WebElement todaysProfit;
	@FindBy(xpath = "//h3[contains(text(),'Net Profit: ')]")
	WebElement netProfit;
	@FindBy(xpath = "//div[@class='info-box']//span[text()='Total purchase']")
	WebElement totalPurchaseInfo;

	public String getTextOfWelcomeMsg() {
		return gUtil.getTextOfElement(welcomeMsg);
	}

	public UsersPageClass navigateToUserPage() {
		...
		return new UsersPageClass(driver);
	...
	public MyProfilePageClass navigationToMyProfile() {
		...
		return new MyProfilePageClass(driver);
	...
	public CustomerGroupsPageClass clickOnCustomerGroupsSubMenu() {
		contactsMenu.click();
		customerGroupsSubMenu.click();
		return new CustomerGroupsPageClass(driver);
