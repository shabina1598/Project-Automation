...
public class CustomerGroupsPageClass {
	...
	WebElement allCustomerGroupsLbl;
	@FindBy(xpath = "//input[@type='search']")
	WebElement searchCustomerGroup;

	@FindBy(xpath = "//table//tbody//tr")
	public List<WebElement> tableRows;// for using table utility
	@FindBy(xpath = "//table//tbody//tr[1]")
	private WebElement firstRow;// for applying wait utlity inside test case
	...
	public void addCustomerGroup(String groupName, String percentage) throws InterruptedException {
	...
	public void searchForCustomerGroup(String user) throws InterruptedException {
